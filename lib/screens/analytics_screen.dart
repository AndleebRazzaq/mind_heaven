...
class _AnalyticsScreenState extends ConsumerState<AnalyticsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final weeklyTrend = insights.weeklyTrend;
    final topEmotion = insights.topEmotionWeekly;
    final topPattern = insights.topPatternWeekly;
    final aiSummary = insights.aiInsightSummary ?? insights.growthInsight;
    final moodInsight = insights.moodInsight;
    final emotionPercentages = insights.emotionPercentages;
    final topPatternCount = insights.topPatternCount;
    final triggerInsight = insights.triggerInsight;
    final allPatternCounts = insights.allPatternCounts;
    final loading = insights.isLoading;
