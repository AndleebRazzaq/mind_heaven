...
class _JournalScreenState extends ConsumerState<JournalScreen> {
  ...
  bool _showCheckIn = true; // Show optional check-in at start
  ...
  Future<void> _onAnalyze() async {
    ...
    await ref
        ...
        .analyze(text, stressBefore: null);
    if (!mounted) return;

    final intervention = ref.read(journalControllerProvider).intervention;
  ...
  void _resetSession() {
    ref.read(journalControllerProvider.notifier).clearSession();
    setState(() {
  ...
  void _savePerspective() {
    unawaited(
      ref.read(journalControllerProvider.notifier).savePostRating(_stressAfter),
    );
  ...
  Widget build(BuildContext context) {
    ...
    final intervention = journal.intervention;
    ...
    return Stack(
      children: [
        SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // Step 1: Optional Light Check-in
              if (_showCheckIn && _currentStep == null) ...[
                _CheckInCard(
                  moodOptions: _moodOptions,
                  selectedMood: _selectedMood,
                  onMoodSelected: (mood) =>
                      setState(() => _selectedMood = mood),
                  onContinue: () => setState(() => _showCheckIn = false),
                  onSkip: () => setState(() => _showCheckIn = false),
                ),
              ...
              if (_currentStep == null) ...[
                ...
                Text(
                  _selectedMood != null
                      ? 'Write more about how you\'re feeling right now.'
              ...
              FilledButton(
                onPressed: journal.isLoading ? null : _onAnalyze,
        ...
        if (journal.isLoading) const _AnalyzingOverlay(),
      ],
    );
  }
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(
                '🧠 Step 1 — Light Check-in (Optional)',
